...
> **Normative authority:** [sci-paper standard](/root/.config/skillshare/upstream/sci-paper-61079914d475/docs/SCIPAPER_STANDARD.md).
...
The original repository is retained at `/root/.config/skillshare/upstream/sci-paper-61079914d475` (commit `61079914d4757750be106b858ef578aa00e4020a`). Resolve repository-level standard, tool, and cross-skill references there; other repository skills are supporting sources, not automatically installed or selected. This local packaging note and the standard link are the only changes to the upstream skill.
