...
Here: a change, bug, or test handled in one place because the **public surface** hid the decision (the other side of leakage). Whether units **should** share a change axis is `cohesion-locality`, including failure locality.
